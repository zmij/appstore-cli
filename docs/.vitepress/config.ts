...
export default defineConfig({
  ...
  head: [
    ...
    [
      'meta',
      {
        ...
        content:
          'Manage iOS App Store Connect listings, IAPs, and subscriptions from YAML files. CLI + bundled MCP server.',
      },
    ],
  ],
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/zmij/appstore-cli' }],
    ...
    editLink: {
      pattern: 'https://github.com/zmij/appstore-cli/edit/master/docs/:path',
